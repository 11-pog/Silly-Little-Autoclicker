...
from MacroClicker.abstract import Action
from MacroClicker.base_actions import *

class MacroClicker():
    def __init__(self, *, trigger_key = 'F8', tempo = 0.1, execution_map: List[Action], loop=None):
